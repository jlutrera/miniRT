...
/*   Updated: 2023/10/18 12:39:18 by adpachec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * @brief Computes the lighting and shadow effects on a cylinder at a given
 point.
 * 
 * This function calculates the lighting and shadow effects on a cylinder at a
 * specific point.
 * It determines the normal at the point, computes the lighting intensity, and
 * adjusts for shadows.
 * 
 ...
 * 
 * @return The color of the cylinder at the point after considering lighting
 * and shadows.
 */
 ...
 * 
 * This function allocates memory for a new cylinder object and initializes 
 * it using
 * the parsed data. It checks for errors in the data and returns the cylinder
 * if successful.
 * 
